...
`http://spark.rstudio.com/johnharrison/shinytestapp/`.

An image of the app using `RSelenium` on a windows 8.1 machine running firefox 16.0

<img src="shinytestapp.png"  />
