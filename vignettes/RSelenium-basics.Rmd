...
<img src="https://res.cloudinary.com/johndharrison/image/upload/v1497012247/RSelenium/basics/RProject.png" title = "RProject front page on linux firefox 26.0" width = '100%'/>
...
with using them cross-platform. They are still in the RSelenium package and can be accessed in the serverUtils directory `file.path(find.package("RSelenium"), "examples/serverUtils")`
