...
For additional options and more control see the [wdman](https://github.com/ropensci/wdman) project.
...
For further detail and any issues you may have with the `rsDriver` function please see the [wdman](https://github.com/ropensci/wdman) project.