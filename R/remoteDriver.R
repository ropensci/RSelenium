...
#'      \item{\code{findElement()}:}{ Search for an element on the page, starting from the document root. The located element will be returned as an id to be used by an object of webElement class. }
#'      \item{\code{findElements()}:}{ Create a new \code{remoteDriver} object. }
#'      \item{\code{getActiveElement()}:}{ Create a new \code{remoteDriver} object. }
#'      \item{\code{click(buttonId)}:}{ Create a new \code{remoteDriver} object. }
#'      \item{\code{doubleclick(buttonId)}:}{ Create a new \code{remoteDriver} object. }
#'      \item{\code{buttondown(buttonId)}:}{ Create a new \code{remoteDriver} object. }
#'      \item{\code{buttonup(buttonId)}:}{ Create a new \code{remoteDriver} object. }
