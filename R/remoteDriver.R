...
remoteDriver <- 
  setRefClass(
    ...
    methods = list(
      ...
      mouseMoveToLocation = function(x = NA_integer_, y = NA_integer_, 
        ...
        if(!is.null(webElement)){
          if(class(webElement) != "webElement"){
            print("webElement should be of class webElement"); return()
          }
      ...
      addCookie = function(name,value,path = "/", domain = NULL, 
                           httpOnly = NULL, expiry = NULL,secure = FALSE){
      ...
      findElement = function(using = c("xpath", "css selector", "id", 
      ...
      findElements = function(using = c("xpath", "css selector", "id", 
                                        "name", "tag name", "class name", 
                                        "link text", "partial link text"), 
                              value){
