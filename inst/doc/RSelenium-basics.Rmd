...
We will demonstrate interacting with frames by way of example. The [R project](https://www.R-project.org/) conviently contains frames so we shall use `RSelenium` to interact with it. 
